...
<section class="section">
  ...
  <div class="col-lg-12">
      <div class="collapse" id="addFormatCollapse">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title"> Medicine formats registration form</h5>
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title">List of medicine formats</h5>
...
<script type="text/javascript">
  ...
  const messageTop = `${header} | List of Medicine formats`;
