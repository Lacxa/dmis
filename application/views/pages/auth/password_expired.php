...
$pwd_expired = $this->session->flashdata('user_isPasswordExpired');
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div class="pt-4 pb-2">
                ...
                <p class="text-center small">Your password may have expired, or it is your first login to DMIS, please reset your password.</p>
            </div>

            <form class="row g-3 needs-validation" novalidate method="post" action="<?php echo base_url('password/expired/'.$action);?>">

              <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>" />

              <div class="col-12">
                  <label for="current" class="form-label">Email</label>
                  <input type="text" name="email" value="<?php echo set_value('email'); ?>" class="form-control" id="email" required>
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                    <input type="password" name="current" class="form-control" id="current" value="<?php echo set_value('current'); ?>" required>
            ...
            <div class="col-12">
                ...
                <div class="input-group has-validation">
                    <input type="password" name="new" class="form-control" id="new" value="<?php echo set_value('new'); ?>" required>
                    <span class="input-group-text password-showhide" id="inputGroupPrepend" style="cursor: pointer;">
                        <i class="show-password bi bi-eye"></i>
                        <i class="hide-password bi bi-eye-slash" style="display: none;"></i>
                    </span>
            ...
            <div class="col-12">
                ...
                <div class="input-group has-validation">
                    <input type="password" name="cnew" class="form-control" id="cnew" value="<?php echo set_value('cnew'); ?>" required>
                    <span class="input-group-text password-showhide" id="inputGroupPrepend" style="cursor: pointer;">
                        <i class="show-password bi bi-eye"></i>
                        <i class="hide-password bi bi-eye-slash" style="display: none;"></i>
                    </span>
