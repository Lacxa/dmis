...
class Filenumber
{
    ...
    /**
     * @var integer Number of total chunks. Default is 4. Example: XXXXX-BBBBB-ZZZZZ-AAAAA
     */
    public $numberChunks = 4;


    /**
     * @var integer Number of total letters per chunk. Default is 5. Example: XX-XX-XX-XX
     */
    public $numberLettersPerChunk = 2;
